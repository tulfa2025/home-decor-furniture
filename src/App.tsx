...
export default function App() {
  ...
  const handleSetHeaderStyle = ()=>{
    /* Don´t re render subheader if the same header style as previous and */
    if (headerStyle === layoutCollection[currentSlide].subheaderStyle) return;
    setHeaderStyle(layoutCollection[currentSlide].subheaderStyle);
