...
const TulfaUpArrow = ({ height, width, fill, arrowColor, handleClick }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <path
          d="M12.5 22.75L20 15.25L27.5 22.75"
          stroke="#433E99"
          stroke-width="1.5"
...
const TulfaDownArrow = ({
  ...
  return (
    <button
      ...
      className={`${buttonStyles} disable_trigger_header_button`}
    >
      <motion.div
        initial={{
          rotate: 0,
      ...
      >
        ...
        >
          ...
          />
          <path
            d="M27.5 17.25L20 24.75L12.5 17.25"
            stroke={arrowColor}
            stroke-width="2"
            stroke-linecap="round"
            stroke-linejoin="round"
...
const TulfaLeftArrow = ({ height, width, className, onClick }) => {
  return (
    <button className={className} onClick={onClick}>
      <svg
        width={width}
        ...
        <defs>
          <clipPath id="clip0_16_631">
            <rect
              ...
              height="12"
              fill="white"
              transform="matrix(0 1 -1 0 26 11)"
            />
          </clipPath>
        </defs>
      </svg>
...
export { TulfaUpArrow, TulfaDownArrow, TulfaRightArrow, TulfaLeftArrow };
